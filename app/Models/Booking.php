...
class Booking extends Model
{
    ...
    public function bookingOptionsHistory()
    {
        return $this->hasMany(BookingOptionHistory::class, 'booking_id', 'id');
    }
    ...
    protected static function boot()
    {
        ...
        static::deleted(function ($row) {
            ...
            $row->bookingOptionsHistory()->delete();
            $row->payment()->delete();
     ...
     * @return $this
     */
    public function updateOrCreateOptionHistory($data)
    {
        $this->bookingOptionsHistory()->delete();
        foreach ($data as $key => $item) {
            ...
            $this->bookingOptionsHistory()->create($nd);
        }
        return $this;
    }
